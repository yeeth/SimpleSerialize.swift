...
extension _SimpleSerializeEncoder.SingleValueContainer: SingleValueEncodingContainer {
...
extension _SimpleSerializeEncoder.SingleValueContainer: _SimpleSerializeEncodingContainer {
    var data: Data {
        return storage
    }
}
